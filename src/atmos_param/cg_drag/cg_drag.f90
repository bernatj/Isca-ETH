...
real        :: cmax=99.6          ! maximum phase speed in gravity wave (before 99.6)
                                  ! spectrum [ m/s ]
real        :: dc=1.2           ! gravity wave spectral resolution (before 1.2)
                                  ! [ m/s ]
                                  ! previous values: 0.6
...
namelist /cg_drag_nml/    cg_drag_freq, cg_drag_offset, &
