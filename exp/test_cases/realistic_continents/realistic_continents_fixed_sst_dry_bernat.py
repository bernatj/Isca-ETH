...
baseexp = Experiment('realistic_continents_control_dry', overwrite_data=False)
...
baseexp.namelist['dry_convection_nml'] = f90nml.Namelist({
    'tau': 14400.,# 4 hours relaxation
    'gamma': 9.8, # K/km (dry lapse rate)
})
...
baseexp.namelist['surface_flux_nml']['land_humidity_prefactor'] = 0.0 #Evaporative resistance over land
...
baseexp.namelist['idealized_moist_phys_nml']['roughness_moist'] = 5.e-4 #rough_moistno evaporation #Ocean roughness lengths
