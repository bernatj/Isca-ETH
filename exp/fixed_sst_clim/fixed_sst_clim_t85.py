...
baseexp = Experiment('fixed_sst_clim_t85', overwrite_data=False)

#Add any input files that are necessary for a particular experiment.
baseexp.inputfiles = [os.path.join(GFDL_BASE,'input/land_masks/era_land_t85.nc'),os.path.join(GFDL_BASE,'input/rrtm_input_files/ozone.nc'),
...
#baseexp.namelist['fms_nml']['domains_stack_size'] = 1240000 #Setting size of stack available to model, which needs to be higher than the default when running at high spatial resolution
...
baseexp.namelist['spectral_dynamics_nml']['valid_range_T'] = [0, 700]
...
baseexp.namelist['rrtm_radiation_nml']['ozone_file'] = 'ozone' #Tell model name of o3 input file

#baseexp.namelist['spectral_init_cond_nml']['initial_temperature'] = 295 #Lower than normal initial temperature
