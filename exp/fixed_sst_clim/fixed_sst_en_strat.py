...
baseexp = Experiment('fixed_sst_en_regx2_strat', overwrite_data=True)
...
baseexp.inputfiles = [os.path.join(GFDL_BASE,'input/land_masks/era_land_t42.nc'),os.path.join(GFDL_BASE,'input/rrtm_input_files/ozone_era.nc'),
                      os.path.join(GFDL_BASE,'input/rrtm_input_files/h2o_era.nc'),os.path.join(GFDL_BASE,'input/sst/sst_en_reg_ersst4.nc'),
...
baseexp.namelist['atmosphere_nml']['tau_file'] = 'tau_1' 
baseexp.namelist['atmosphere_nml']['u_wind_file'] = 'u_clim_isca' 
baseexp.namelist['atmosphere_nml']['v_wind_file'] = 'v_clim_isca' 
baseexp.namelist['atmosphere_nml']['t_file'] = 't_clim_isca' 
...
baseexp.namelist['mixed_layer_nml']['sst_file'] = 'sst_en_reg_ersst4' #Set name of sst input file
