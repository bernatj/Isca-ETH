...
baseexp = Experiment('fixed_sst_ln_regx2_t63', overwrite_data=True)
...
baseexp.inputfiles = [os.path.join(GFDL_BASE,'input/land_masks/era_land_t63.nc'),os.path.join(GFDL_BASE,'input/rrtm_input_files/ozone_era.nc'),
                      os.path.join(GFDL_BASE,'input/rrtm_input_files/h2o_era.nc'),os.path.join(GFDL_BASE,'input/sst/sst_ln_reg_ersst4.nc'),
...
baseexp.namelist['mixed_layer_nml']['sst_file'] = 'sst_ln_reg_ersst4' #Set name of sst input file
...
baseexp.namelist['rrtm_radiation_nml']['dt_rad'] = 2400  #Use 4320 as RRTM timestep
