...
baseexp = Experiment('fixed_sst_clim', overwrite_data=False)
...
baseexp.inputfiles = [os.path.join(GFDL_BASE,'input/land_masks/era_land_t42.nc'),os.path.join(GFDL_BASE,'input/rrtm_input_files/ozone_1990.nc'),
                      os.path.join(GFDL_BASE,'input/sst_clim_ersst.nc'), os.path.join(base_dir,'input/siconc_clim_amip.nc')]
...
baseexp.namelist['spectral_dynamics_nml']['surf_res'] = 0.35 #Parameter that sets the vertical distribution of sigma levels
...
baseexp.namelist['mixed_layer_nml']['ice_file'] = 'siconc_clim_eraint' #Set name of sst input file
...
baseexp.namelist['rrtm_radiation_nml']['dt_rad'] = 3600   #Use 4320 as RRTM timestep
