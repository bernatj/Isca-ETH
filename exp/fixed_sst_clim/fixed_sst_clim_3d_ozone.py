...
baseexp = Experiment('fixed_sst_clim_zm_strat_up', overwrite_data=True)
...
baseexp.inputfiles = [os.path.join(GFDL_BASE,'input/land_masks/era_land_t42.nc'),os.path.join(GFDL_BASE,'input/rrtm_input_files/ozone_era.nc'),
                      os.path.join(GFDL_BASE,'input/rrtm_input_files/h2o_era.nc'),os.path.join(GFDL_BASE,'input/sst/sst_clim_ersstv4.nc'),
                       ...
                       os.path.join(GFDL_BASE,'input/nudging/tau_strat_6h_up.nc'),os.path.join(GFDL_BASE,'input/nudging/v_clim_isca.nc'),
...
baseexp.namelist['atmosphere_nml']['tau_file'] = 'tau_strat_6h_up' 
...
#Lets do a run!
#diag.add_file('atmos_daily_%2d' % 1, 1, 'days', time_units='days')
