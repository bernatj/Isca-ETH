...
baseexp = Experiment('fixed_sst_clim_bucket', overwrite_data=False)
...
baseexp.namelist['mixed_layer_nml']['depth'] = 10. #Mixed layer depth
baseexp.namelist['mixed_layer_nml']['land_option'] = 'input' #Tell mixed layer to get land mask from input file
baseexp.namelist['mixed_layer_nml']['land_h_capacity_prefactor'] = 0.15 #What factor to multiply mixed-layer depth by over land. 
