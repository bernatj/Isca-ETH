...
baseexp = Experiment('q_fluxes_garfinkel_30m', overwrite_data=False)
...
baseexp.namelist['mixed_layer_nml']['depth'] = 30. #Mixed layer depth
...
baseexp.namelist['mixed_layer_nml']['do_warmpool'] = True #Don't use the prescribed analytical formula for q-fluxes
