...
baseexp = Experiment('fixed_sst_ln_nudging', overwrite_data=False)
...
baseexp.inputfiles = [os.path.join(GFDL_BASE,'input/land_masks/era_land_t42.nc'),os.path.join(GFDL_BASE,'input/rrtm_input_files/ozone_era.nc'),
                      os.path.join(GFDL_BASE,'input/rrtm_input_files/h2o_era.nc'),os.path.join(GFDL_BASE,'input/sst/sst_ln_ersst4.nc'),
                       os.path.join(GFDL_BASE,'input/seaice/siconc_clim_eraint.nc'),os.path.join(GFDL_BASE,'input/nudging/u_clim_era.nc'),
                       os.path.join(GFDL_BASE,'input/nudging/tau_1.nc'),os.path.join(GFDL_BASE,'input/nudging/v_clim_era.nc')]
...
baseexp.namelist['mixed_layer_nml']['sst_file'] = 'sst_ln_ersst4' #Set name of sst input file
