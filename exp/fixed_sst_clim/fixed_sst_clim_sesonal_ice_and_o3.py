...
baseexp = Experiment('fixed_sst_clim_gw', overwrite_data=False)
...
baseexp.inputfiles = [os.path.join(GFDL_BASE,'input/land_masks/era_land_t42.nc'),os.path.join(GFDL_BASE,'input/rrtm_input_files/ozone_era.nc'),
                      os.path.join(GFDL_BASE,'input/rrtm_input_files/h2o_era.nc'),os.path.join(GFDL_BASE,'input/sst/sst_clim_era.nc'),
...
#baseexp.namelist['cg_drag_nml']['Bt_0'] =  0.0 #Gravity wave parametrization
#baseexp.namelist['cg_drag_nml']['Bt_nh'] = 0.0
#baseexp.namelist['cg_drag_nml']['Bt_eq'] = 0.0
#baseexp.namelist['cg_drag_nml']['Bt_sh'] = 0.0
#baseexp.namelist['cg_drag_nml']['phi0n'] =  15 #Gravity wave parametrization
#baseexp.namelist['cg_drag_nml']['phi0s'] = -15
#baseexp.namelist['cg_drag_nml']['dphin '] = 10
#baseexp.namelist['cg_drag_nml']['dphis'] = -10

baseexp.namelist['cg_drag_nml']['source_level_pressure'] = 325.e+02
baseexp.namelist['cg_drag_nml']['damp_level_pressure'] = 0.85e2
baseexp.namelist['cg_drag_nml']['cg_drag_freq'] = 4832

baseexp.namelist['spectral_dynamics_nml']['surf_res'] = 0.3 #Parameter that sets the vertical distribution of sigma levels
baseexp.namelist['spectral_dynamics_nml']['num_levels'] = 70 #Number of vertical levels
