...
baseexp = Experiment('fixed_sst_clim_lowtrop_strong_nudging', overwrite_data=False)
...
baseexp.inputfiles = [os.path.join(GFDL_BASE,'input/land_masks/era_land_t42.nc'),os.path.join(GFDL_BASE,'input/rrtm_input_files/ozone_era.nc'),
                      os.path.join(GFDL_BASE,'input/rrtm_input_files/h2o_era.nc'),os.path.join(GFDL_BASE,'input/sst/sst_clim_ersst.nc'),
                       os.path.join(GFDL_BASE,'input/seaice/siconc_clim_eraint.nc'),os.path.join(GFDL_BASE,'input/nudging/u_clim_era.nc'),
                       os.path.join(GFDL_BASE,'input/nudging/tau_low_trop_05.nc'),os.path.join(GFDL_BASE,'input/nudging/v_clim_era.nc'),
                       os.path.join(GFDL_BASE,'input/nudging/t_clim_era.nc')]
...
baseexp.namelist['atmosphere_nml']['nudging'] = True 
baseexp.namelist['atmosphere_nml']['nudge_winds'] = True
baseexp.namelist['atmosphere_nml']['tau_file'] = 'tau_low_trop_05' 
baseexp.namelist['atmosphere_nml']['u_wind_file'] = 'u_clim_era' 
baseexp.namelist['atmosphere_nml']['v_wind_file'] = 'v_clim_era' 
baseexp.namelist['atmosphere_nml']['t_file'] = 't_clim_era' 
...
#baseexp.namelist['damping_driver_nml']['trayfric'] = -1.0
#baseexp.namelist['damping_driver_nml']['do_cg_drag']  = True #Gravity wave parametrization
#baseexp.namelist['damping_driver_nml']['do_rayleigh'] = False #Gravity wave parametrization
...
baseexp.namelist['rrtm_radiation_nml']['fixed_water_lat'] = 40
