...
baseexp = Experiment('fixed_sst_clim_heating', overwrite_data=False)
...
baseexp.inputfiles = [os.path.join(GFDL_BASE,'input/land_masks/era_land_t42.nc'),os.path.join(GFDL_BASE,'input/rrtm_input_files/ozone_era.nc'),
                      os.path.join(GFDL_BASE,'input/rrtm_input_files/h2o_era.nc'),os.path.join(GFDL_BASE,'input/sst/sst_clim_ersstv4.nc'),
                       os.path.join(GFDL_BASE,'input/seaice/siconc_clim_eraint.nc'),os.path.join(GFDL_BASE,'input/heating/heating_en_regx4_isca.nc')]
...
baseexp.namelist['atmosphere_nml']['artificial_heating'] = False
baseexp.namelist['atmosphere_nml']['heating_file'] = 'heating_en_regx4_isca' 
