...
baseexp = Experiment('fixed_sst_clim_noice', overwrite_data=False)
...
baseexp.inputfiles = [os.path.join(GFDL_BASE,'input/land_masks/era_land_t42.nc'),os.path.join(GFDL_BASE,'input/rrtm_input_files/ozone_1990.nc'),
                      os.path.join(GFDL_BASE,'input/sst/sst_clim_ersst.nc')]
...
baseexp.namelist['mixed_layer_nml']['update_albedo_from_ice'] = False #Use the simple ice model to update surface albedo
