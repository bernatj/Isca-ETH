...
baseexp = Experiment('test_simulation', overwrite_data=True)
...
baseexp.namelist['mixed_layer_nml']['do_qflux'] = True  #Don't use the prescribed analytical formula for q-fluxes
baseexp.namelist['mixed_layer_nml']['do_read_sst'] = False #Read in sst values from input file
baseexp.namelist['mixed_layer_nml']['do_sc_sst'] = False  #Do specified ssts (need both to be true)
