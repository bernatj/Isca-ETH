...
baseexp = Experiment('fixed_sst_en_50lev', overwrite_data=False)
...
baseexp.inputfiles = [os.path.join(GFDL_BASE,'input/land_masks/era_land_t42.nc'),os.path.join(GFDL_BASE,'input/rrtm_input_files/ozone_1990.nc'),
                      os.path.join(GFDL_BASE,'input/sst_en_ersst4.nc'), os.path.join(base_dir,'input/siconc_clim_amip.nc')]
...
baseexp.namelist['mixed_layer_nml']['sst_file'] = 'sst_en_ersst4' #Set name of sst input file
