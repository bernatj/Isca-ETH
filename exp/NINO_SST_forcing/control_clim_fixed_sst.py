...
baseexp = Experiment('control_fixed_sst_seasonal', overwrite_data=False)
...
baseexp.inputfiles = [os.path.join(GFDL_BASE,'input/land_masks/era_land_t42.nc'),os.path.join(GFDL_BASE,'input/rrtm_input_files/ozone_1990.nc'),
                      os.path.join(GFDL_BASE,'input/sst_clim_ersstv4.nc'), os.path.join(base_dir,'input/siconc_clim_amip.nc')]
