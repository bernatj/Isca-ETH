...
baseexp = Experiment('test', overwrite_data=False)
...
baseexp.inputfiles = [os.path.join(GFDL_BASE,'input/land_masks/era_land_t42.nc'),os.path.join(GFDL_BASE,'input/rrtm_input_files/ozone_1990.nc'),
                      os.path.join(base_dir,'input/sst_en.nc'), os.path.join(base_dir,'input/siconc_clim_amip.nc')]
...
baseexp.namelist['spectral_dynamics_nml']['surf_res'] = 0.4 #Parameter that sets the vertical distribution of sigma levels
...
baseexp.namelist['mixed_layer_nml']['sst_file'] = 'sst_en' #Set name of sst input file
...
baseexp.namelist['rrtm_radiation_nml']['solday'] = 32.      #run the model with constant winter conditions
